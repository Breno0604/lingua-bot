...
# Voz Rachel (feminina americana) — padrao para o bot
...
class ElevenLabsService:
    ...
    async def generate_speech(self, text: str) -> Optional[bytes]:
        ...
        # 2. Verifica cache
        cached = self.cache.get(truncated)
    ...
    async def _try_elevenlabs(self, text: str) -> Optional[bytes]:
        ...
        try:
            ...
            logger.error("Erro ao gerar audio com ElevenLabs: %s", e)
            return None
